...
train_X, train_feature_names = vectorize(train_data)

# Get the test data.
test_data = pd.read_csv("test.csv")
test_X, test_feature_names = vectorize(test_data)

# Prepare the test matrix for fitting into the classifiers which expect an train_X matrix.
new_matrix = matrix_fit(test_X, test_feature_names, train_X, train_feature_names)
...
test_result = svc.score(new_matrix, test_data['topic'])
...
test_result = rfc.score(new_matrix, test_data['topic'])
...
test_result = mnb.score(new_matrix, test_data['topic'])
